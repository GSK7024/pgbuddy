...
const getSidebarLinks = (t: (k: string) => string) => [
  ...
  { name: "Mess Plans", href: "/dashboard/mess/plans", icon: UtensilsCrossed },
  { name: "Mess Members", href: "/dashboard/mess/members", icon: Users },
  { name: "Mess Attendance", href: "/dashboard/mess/attendance", icon: UserCheck },
  { name: "Mess Payments", href: "/dashboard/mess/payments", icon: CreditCard },
