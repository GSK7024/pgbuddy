...
const TermsOfService = () => (
  <StaticPageLayout title="Terms of Service" description="PG Buddy terms of service. Rules and guidelines for using our PG management platform." canonical="/terms">
    ...
    <p>By accessing or using PG Buddy, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</p>

    <h2 className="text-xl font-semibold text-foreground">2. Description of Service</h2>
    <p>PG Buddy provides a web-based platform for paying guest (PG) property management, including tenant management, rent tracking, document handling, and communication tools.</p>
    ...
    <p>PG Buddy facilitates rent tracking but is not responsible for actual financial transactions between owners and tenants. Subscription payments for premium plans are processed via Razorpay.</p>
    ...
    <p>PG Buddy is provided "as is" without warranties. We are not liable for disputes between owners and tenants, payment disputes, or any damages arising from platform use.</p>
    ...
    <p>For questions about these terms, email <a href="mailto:legal@pgbuddy.in" className="text-primary hover:underline">legal@pgbuddy.in</a>.</p>
  </StaticPageLayout>
);
