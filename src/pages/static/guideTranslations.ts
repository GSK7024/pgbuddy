...
export const guideTranslations: Record<Language, GuideContent> = {
  en: {
    ...
    needHelpDesc: "Contact our support team at support@pgbuddy.in or visit the Help Center for more assistance.",
    ...
    ownerSections: [
      {
        ...
        steps: [
          {
            title: "Open the PG Buddy Website",
          ...
          },
          {
            ...
            desc: "After clicking 'Create Account', check your email inbox (and spam/junk folder) for a verification link from PG Buddy. Click the link to activate your account. You cannot log in until you verify your email.",
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            tip: "Screenshot the invite code and send it on WhatsApp to your tenant along with a message like: 'Download PG Buddy and sign up with [their email]. Then use invite code [code] to join your room.'",
          },
        ],
      },
      {
  ...
  hi: {
    ...
    needHelpDesc: "हमारी सहायता टीम से support@pgbuddy.in पर संपर्क करें या सहायता केंद्र पर जाएं।",
    ...
    ownerSections: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            desc: "'Create Account' पर क्लिक करने के बाद, अपने ईमेल इनबॉक्स (और स्पैम/जंक फ़ोल्डर) में PG Buddy से वेरिफिकेशन लिंक देखें। लिंक पर क्लिक करके अकाउंट एक्टिवेट करें।",
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            tip: "WhatsApp पर इस तरह मैसेज भेजें: 'PG Buddy पर [इस ईमेल] से साइनअप करें और इनवाइट कोड [कोड] डालें।'",
          },
        ],
      },
      {
  ...
  mr: {
    ...
    needHelpDesc: "आमच्या सपोर्ट टीमशी support@pgbuddy.in वर संपर्क साधा.",
    ...
    ownerSections: [
      {
        ...
        steps: [
          { title: "PG Buddy वेबसाइट उघडा", desc: "ब्राउझरमध्ये pgbuddy.lovable.app उघडा. 'Get Started Free' किंवा 'Sign Up' बटणावर क्लिक करा.", image: "/guide/signup-page.jpg" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "इनव्हाइट कोड शेअर करा", desc: "कोड WhatsApp, SMS किंवा वैयक्तिकरित्या भाडेकरूला द्या.", warning: "कोड 7 दिवसांत expire होतो.", tip: "WhatsApp वर मेसेज पाठवा: 'PG Buddy वर [या ईमेलने] साइनअप करा आणि कोड [कोड] वापरा.'" },
        ],
      },
      {
    ...
    tenantSections: [
      {
        title: "1. खाते तयार करणे आणि लॉगिन",
        steps: [
          { title: "PG Buddy वेबसाइट उघडा", desc: "pgbuddy.lovable.app उघडा. 'Sign Up' वर क्लिक करा.", image: "/guide/signup-page.jpg" },
  ...
  ta: {
    ...
    needHelpDesc: "support@pgbuddy.in இல் எங்கள் ஆதரவு குழுவை தொடர்புகொள்ளுங்கள்.",
    ...
    ownerSections: [
      {
        ...
        steps: [
          { title: "PG Buddy வலைத்தளத்தைத் திறக்கவும்", desc: "pgbuddy.lovable.app என்ற முகவரியைத் திறந்து 'Sign Up' கிளிக் செய்யுங்கள்.", image: "/guide/signup-page.jpg" },
  ...
  te: {
    ...
    needHelpDesc: "support@pgbuddy.in కు ఇమెయిల్ పంపండి.",
  ...
  kn: {
    ...
    needHelpDesc: "support@pgbuddy.in ಗೆ ಇಮೇಲ್ ಮಾಡಿ.",
  ...
  ml: {
    ...
    needHelpDesc: "support@pgbuddy.in ലേക്ക് ഇമെയിൽ അയക്കുക.",
  ...
  bn: {
    ...
    needHelpDesc: "support@pgbuddy.in এ ইমেইল পাঠান।",
  ...
  gu: {
    ...
    needHelpDesc: "support@pgbuddy.in પર ઈમેલ કરો.",
  ...
  pa: {
    ...
    needHelpDesc: "support@pgbuddy.in 'ਤੇ ਈਮੇਲ ਕਰੋ।",
  ...
  or: {
    ...
    needHelpDesc: "support@pgbuddy.in କୁ ଇମେଲ୍ କରନ୍ତୁ।",
  ...
  as: {
    ...
    needHelpDesc: "support@pgbuddy.in লৈ ইমেইল কৰক।",
